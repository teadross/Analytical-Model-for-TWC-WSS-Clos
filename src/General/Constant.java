...
public class Constant {
    ...
    public final static double epison = 0.0000001;

    public final static int W = w;
    public final static int M = 1;
    public final static int R = r;
//    public final static double Rho = (double)n*rho/(double)m*r;
    ...
    private static double CalculateCarriedLoad(){
        ...
        BigDecimal rhoRoute = rhoE.multiply(BigDecimal.valueOf(n).divide(BigDecimal.valueOf(m*r),15,BigDecimal.ROUND_HALF_DOWN));
